...
Implements Section 2.1 of the Agent Rating System Design:
- RatingRecord with 5 dimensions (1-100 scale)
- JSON serialization / deserialization
- SHA-256 record_hash computation
"""
...
# The five rating dimensions (Section 2.2)
DIMENSIONS = (
    "reliability",
    "accuracy",
    "latency",
...
# Score buckets for display (Section 2.2)
SCORE_BUCKETS = {
    (1, 20): "poor",
    (21, 40): "below_average",
    (41, 60): "average",
...
class InteractionEvidence:
    """Evidence from the interaction being rated (Section 2.1)."""
...
@dataclass
class RatingRecord:
    """A single rating record per Section 2.1 schema.
    ...
    def compute_hash(self) -> str:
        ...
        The hash covers: version, rating_id, timestamp, interaction_id,
        rater_id, ratee_id, all dimensions (sorted), and evidence.
        This ensures tamper evidence per Section 2.3.
        """
        canonical = {
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "timestamp": self.timestamp,
            "interaction_id": self.interaction_id,
            "rater": {"agent_id": self.rater_id},
            "ratee": {"agent_id": self.ratee_id},
    ...
    def from_dict(cls, d: Dict[str, Any]) -> "RatingRecord":
        ...
        record = cls(
            rater_id=d.get("rater", {}).get("agent_id", ""),
            ratee_id=d.get("ratee", {}).get("agent_id", ""),
